...
To run the code:
1) Pip install all below libraries
- pandas==2.3.3
- plotly==6.6.0
- pytest==9.0.2
- streamlit==1.53.1
...
3) Open browser to page that streamlit opened